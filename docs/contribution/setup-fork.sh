...
# upstream   https://github.com/lNikazzzl/ProxmoxVE.git (fetch)
# upstream   https://github.com/lNikazzzl/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/lNikazzzl/ProxmoxVE"
echo ""
